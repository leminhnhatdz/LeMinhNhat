...
_G.deb = {} 
    ...
    elseif game.PlaceId == 7449423635 then
        World3 = true
    else game.Players.LocalPlayer:Kick("[RinMeka] // Wrong game, Auto Join BF in 10s, leave if you want!") 
      wait(10) 
...
u5.new("<Color=Yellow>RinMeka Hub Auto Bounty<Color=/>"):Display()
wait()
...
wait()
u5.new("<Color=Yellow>bit.ly/RinMekahub<Color=/>"):Display()      
spawn(function()
    while task.wait() do
        pcall(function()
            if true then
        ...
        ["embeds"] = {
            {
                ...
                ["color"] = 16228095,
                ["title"] = "RinMeka Community - Bounty Hunt", 
                ...
                ["footer"] = {
                    ["text"] = "RinMeka Community - https://discord.gg/3CXCW8rQ",
                },
